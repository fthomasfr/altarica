 ...
 * <ul>
 *   <li>{@link fr.onair.dsl.safety.altarica.altarica.impl.CardinalityImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CardinalityImpl extends MinimalEObjectImpl.Container implements Cardinality
{
  ...
  {
    return AltaricaPackage.Literals.CARDINALITY;
  }
  ...
  public NotificationChain basicSetExpression(AbstractExpression newExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AltaricaPackage.CARDINALITY__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(AbstractExpression newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AltaricaPackage.CARDINALITY__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AltaricaPackage.CARDINALITY__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AltaricaPackage.CARDINALITY__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AltaricaPackage.CARDINALITY__EXPRESSION:
