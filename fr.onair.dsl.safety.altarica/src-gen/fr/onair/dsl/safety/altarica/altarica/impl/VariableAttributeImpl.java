 ...
 * <ul>
 *   <li>{@link fr.onair.dsl.safety.altarica.altarica.impl.VariableAttributeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableAttributeImpl extends MinimalEObjectImpl.Container implements VariableAttribute
{
  ...
  {
    return AltaricaPackage.Literals.VARIABLE_ATTRIBUTE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AltaricaPackage.VARIABLE_ATTRIBUTE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AltaricaPackage.VARIABLE_ATTRIBUTE__NAME:
        return getName();
    }
